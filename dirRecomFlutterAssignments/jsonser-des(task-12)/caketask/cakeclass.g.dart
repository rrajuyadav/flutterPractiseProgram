...
part of 'cakeclass.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Cakeclass _$CakeclassFromJson(Map<String, dynamic> json) => Cakeclass(
      json['items'] == null
          ? null
          : Items.fromJson(json['items'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$CakeclassToJson(Cakeclass instance) => <String, dynamic>{
